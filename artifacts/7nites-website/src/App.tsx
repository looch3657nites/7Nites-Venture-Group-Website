...
function ContactSection() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setSubmitError("We couldn't send your enquiry right now. Please try again or contact us directly at hello@7nitesentertainment.co.za.");
    } finally {
